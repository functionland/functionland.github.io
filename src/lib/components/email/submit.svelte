...
<script>
    ...
    const hideMessage = () => { messageVisible = false; };
...
<div class="sub-wrapper">
    ...
    {/if}
    <div class="sub-box">
        <div class="sub-msg p-large">
            Join our mailing list to hear from us!
        </div>
        <form class="sub-form" on:submit|preventDefault={submitEmail} action="https://landing.mailerlite.com/webforms/landing/t0d8c1" method="post">
            ...
            <input
                ...
                required
                on:focus={()=>{bluredWithInvalid = false;}}
