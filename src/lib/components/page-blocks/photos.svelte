        ...
        <div class="wrapper grid">
            {#each data.photos as photo}
                {#if innerWidth < 960}
                    ...
                    <div class="image-box" style={`aspect-ratio: ${photo.srcset.small.width}/${photo.srcset.small.height};`}>
                        <img src={photo.srcset.small.src} alt="" width={photo.srcset.small.width} height={photo.srcset.small.height} loading="lazy" decoding="async"/>
                    </div>
                {:else}
                    <div class={`image-box ${data.ref}`} style={`aspect-ratio: ${photo.srcset.large.width}/${photo.srcset.large.height}; width: ${(photo.srcset.large.width / 1530) * 100}%`} >
